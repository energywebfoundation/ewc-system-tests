...
describe(' Contracts', function() {
  ...
  describe('NodeControlLookUp', function() {
    ...
    it("should not allow someone other then the owner to change the nodeControlAddress", async function() {
      ...
      try {
        await nodeControlLookUp.methods.changeAddress('0x6B7948D60652237753cE513317AB634d8db1CaC8').call({
    ...
    it("should allow owner to change the nodeControlSimple address", async function() {
      ...
      const txA = {
        value: '0',
        data: nodeControlLookUp.methods.changeAddress('0x49B6e2386Bbf577c457B231bfd1D36bd8A916b4b').encodeABI()
      };
      await utils.sendMultisigTransaction(web3, netOpsMultiSig, txA, values.address_book["NODECONTROL_LOOKUP"]);

      (await nodeControlLookUp.methods.nodeControlContract().call()).toLowerCase().should.be.equal('0x49B6e2386Bbf577c457B231bfd1D36bd8A916b4b'.toLowerCase());
  ...
  describe('NodeControlSimple', function() {
    ...
    it("should not allow anyone other then the owner to update a validator state", async function() {
      oldValidatorState = await nodeControlSimple.methods.retrieveExpectedState('0x6B7948D60652237753cE513317AB634d8db1CaC8').call();
      try {
        await nodeControlSimple.methods.updateValidator('0x6B7948D60652237753cE513317AB634d8db1CaC8', "0xe", "parity", "0xf", "https://raw.githubusercontent.com/Volta.json", true).send({
          from: '0x49B6e2386Bbf577c457B231bfd1D36bd8A916b4b',
          gasLimit: 50000
        });
      } catch (err) {}

      eState = await nodeControlSimple.methods.retrieveExpectedState('0x6B7948D60652237753cE513317AB634d8db1CaC8').call();
    ...
    it("should allow the owner to update a validator state", async function() {
      ...
      const txA = {
        value: '0',
        data: nodeControlSimple.methods.updateValidator('0x6B7948D60652237753cE513317AB634d8db1CaC8', "0xe0d81206592a85a612a3bdb4300f538f67f9229ef7ae0fc0c1a098eefa467727", "parity/parity:v2.3.3", "0xfda42852939fef61daccd00d20ef07e2316de2e023de48c861701bfa73cfca47", "https://raw.githubusercontent.com/energywebfoundation/ewf-chainspec/99fa89b92b35219ddf38c886a75623c85bc9c696/Volta.json", true).encodeABI()
      }
      const receipt = await utils.sendMultisigTransaction(web3, netOpsMultiSig, txA, values.address_book["NODECONTROL_SIMPLE"]);

      var eState = await nodeControlSimple.methods.retrieveExpectedState('0x6B7948D60652237753cE513317AB634d8db1CaC8').call();
    ...
    it("should return false if an update has not been confirmed", async function() {
      (await nodeControlDb.methods.isUpdateConfirmed('0x6B7948D60652237753cE513317AB634d8db1CaC8').call()).should.be.equal(false);
    })
    ...
    it("should allow a validator to confirm an update", async function() {
      await nodeControlSimple.methods.confirmUpdate().send({
        from: '0x6B7948D60652237753cE513317AB634d8db1CaC8',
        gasLimit: 500000
      });
      (await nodeControlDb.methods.isUpdateConfirmed('0x6B7948D60652237753cE513317AB634d8db1CaC8').call()).should.be.equal(true);
    })
    ...
    it("should prep the state for further tests", async function() {
      const txA = {
        value: '0',
        data: nodeControlSimple.methods.updateValidator('0x6B7948D60652237753cE513317AB634d8db1CaC8', "0xe0d81206592a85a612a3bdb4300f538f67f9229ef7ae0fc0c1a098eefa467720", "parity/parity:v2.3.0", "0xfda42852939fef61daccd00d20ef07e2316de2e023de48c861701bfa73cfca40", "https://raw.githubusercontent.com/energywebfoundation/ewf-chainspec/99fa89b92b35219ddf38c886a75623c85bc9c696/Volta.jso0", false).encodeABI()
      }
      const receipt = await utils.sendMultisigTransaction(web3, netOpsMultiSig, txA, values.address_book["NODECONTROL_SIMPLE"]);
    })
  ...
  describe('NodeControlDB', function() {
    ...
    it("should not allow anyone other then the owner to change the lookup contract", async function() {
      ...
      try {
        await nodeControlDb.methods.changeLookUpContract('0x6B7948D60652237753cE513317AB634d8db1CaC8').send({
          from: '0x6B7948D60652237753cE513317AB634d8db1CaC8'
        });
      } catch (err) {}
    ...
    it("should allow the owner to change the lookup contract", async function() {
      const txA = {
        value: '0',
        data: nodeControlDb.methods.changeLookUpContract('0x6B7948D60652237753cE513317AB634d8db1CaC8').encodeABI()
      }
      await utils.sendMultisigTransaction(web3, netOpsMultiSig, txA, values.address_book["NODECONTROL_DB"]);


      (await nodeControlDb.methods.nodeControlLookUp().call()).should.be.equal('0x6B7948D60652237753cE513317AB634d8db1CaC8');
    ...
    it("should not allow anyone other then the logic contract to call setState", async function() {
      try {
        await nodeControlDb.methods.setState('0x6B7948D60652237753cE513317AB634d8db1CaC8', "0xe0d81206592a85a612a3bdb4300f538f67f9229ef7ae0fc0c1a098eefa467721", "parity/parity:v2.3.1", "0xfda42852939fef61daccd00d20ef07e2316de2e023de48c861701bfa73cfca41", "https://raw.githubusercontent.com/energywebfoundation/ewf-chainspec/99fa89b92b35219ddf38c886a75623c85bc9c696/Volta.json", true).send({
          from: '0x6B7948D60652237753cE513317AB634d8db1CaC8',
          gasLimit: 50000
        });
      } catch (err) {}
